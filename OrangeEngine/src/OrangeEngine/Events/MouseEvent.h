...
SPEC_SUBCLASS(MouseMovedEvent)
SPEC_SUBCLASS(MouseScrolledEvent)
SPEC_SUBCLASS(MouseButtonEvent)
SPEC_SUBCLASS(MouseButtonPressedEvent)
SPEC_SUBCLASS(MouseButtonReleasedEvent)